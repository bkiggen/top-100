...
describe 'Top 100 Phrases CLI' do # rubocop:disable Metrics/BlockLength
  ...
  it 'should ignore case, new lines, and special characters' do
    ...
    expected = [["i like sandwiches", 20], ["like sandwiches i", 20], ["sandwiches i like", 20], ["i like cake", 10], ["like cake i", 9], ["cake i like", 9]]
  ...
  it 'should accept multiple file path arguments' do
    ...
    expected = [["i like sandwiches", 22], ["like sandwiches i", 21], ["sandwiches i like", 21], ["i like cake", 10], ["like cake i", 10], ["cake i like", 10]]
